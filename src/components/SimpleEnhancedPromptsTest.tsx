...
const SimpleEnhancedPromptsTest: React.FC = () => {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <h2 className="text-2xl font-bold mb-4">🧪 Simple Enhanced Prompts Test</h2>
      ...
      {result && (
        <div className="space-y-6">
          ...
          <div className="grid gap-4">
            ...
            {/* Enhanced Prompts Display - Simple Version */}
            <div className="p-4 border rounded-lg">
              <h3 className="font-semibold mb-4">Enhanced Prompts ({result.enhancedPrompts?.length || 0})</h3>
...
export default SimpleEnhancedPromptsTest;
